...
// mpic++ -o bin/RKAB_mpi.exe main/RKAB_mpi.C
// mpirun -np 2 ./bin/RKAB_mpi.exe dense 1 1E-10 2000 100 20
...
int main (int argc, char *argv[]) {
	...
	if(argc != 9) {
		...
		cout << "'mpirun -np <nproc> ./bin/RKAB_mpi_alpha.exe <data_set> <n_runs> <eps> <M> <N> <block_size> <alpha> <max_it_stop>'" << endl;
		exit(1);
	}
