...
// mpic++ -o bin/RKA_mpi.exe main/RKA_mpi.C
// mpirun -np 2 ./bin/RKA_mpi.exe dense 1 1E-10 2000 100 20
...
int main (int argc, char *argv[]) {
	...
	if(argc != 7) {
		...
		cout << "'mpirun -np <nproc> ./bin/RKA_mpi.exe <data_set> <n_runs> <eps> <M> <N> <max_it_stop>'" << endl;
		exit(1);
	}
