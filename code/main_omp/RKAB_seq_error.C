...
int main (int argc, char *argv[]) {
	...
	if(argc != 9) {
		...
		cout << "'./bin/RKAB_seq_error.exe <data_set> <M> <N> <blocks> <it_per_thread> <max_it_stop> <block_repeat> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/omp/RKAB_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(blocks) + "_" + to_string(it_per_thread) + "_" + to_string(block_repeat) + ".txt";
	string filename_res = "errors/omp/RKAB_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(blocks) + "_" + to_string(it_per_thread) + "_" + to_string(block_repeat) + ".txt";
