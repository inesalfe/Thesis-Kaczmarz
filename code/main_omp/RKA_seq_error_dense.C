...
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 1 100000 1000
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 2 100000 1000
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 4 100000 1000
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 8 100000 1000
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 20 100000 1000
// ./bin/RKA_seq_error_dense.exe dense 4000 1000 50 100000 1000

int main (int argc, char *argv[]) {

	if(argc != 7) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RKA_seq_error_dense.exe <data_set> <M> <N> <threads> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/seq/RKA_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
	string filename_res = "errors/seq/RKA_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
