...
int main (int argc, char *argv[]) {
	...
	if(argc != 7) {
		...
		cout << "'./bin/RK_seq_countSC.exe <data_set> <n_runs> <eps> <M> <N> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	cout << sqrt(sqrNormDiff(x_sol, x, N)) << " " << duration_total << " " << count_sc1/n_runs << " " << count_sc2/n_runs << endl;
