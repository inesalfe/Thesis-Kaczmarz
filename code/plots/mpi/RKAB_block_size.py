...
plt.scatter(x1, time_dim1_seq, color='gray')
plt.plot(x1, time_dim1_seq, linewidth=1.5, color='gray', label=r'Sequential')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x1, lines_dim1_seq, color='gray')
plt.plot(x1, lines_dim1_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x1, it_dim1_seq, color='gray')
plt.plot(x1, it_dim1_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x2, time_dim2_seq, color='gray')
plt.plot(x2, time_dim2_seq, linewidth=1.5, color='gray', label=r'Sequential')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x2, lines_dim2_seq, color='gray')
plt.plot(x2, lines_dim2_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x2, it_dim2_seq, color='gray')
plt.plot(x2, it_dim2_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x3, time_dim3_seq, color='gray')
plt.plot(x3, time_dim3_seq, linewidth=1.5, color='gray', label=r'Sequential')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x3, lines_dim3_seq, color='gray')
plt.plot(x3, lines_dim3_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x3, it_dim3_seq, color='gray')
plt.plot(x3, it_dim3_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x4, time_dim4_seq, color='gray')
plt.plot(x4, time_dim4_seq, linewidth=1.5, color='gray', label=r'Sequential')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x4, lines_dim4_seq, color='gray')
plt.plot(x4, lines_dim4_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x4, it_dim4_seq, color='gray')
plt.plot(x4, it_dim4_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x5, time_dim5_seq, color='gray')
plt.plot(x5, time_dim5_seq, linewidth=1.5, color='gray', label=r'Sequential')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x5, lines_dim5_seq, color='gray')
plt.plot(x5, lines_dim5_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x5, it_dim5_seq, color='gray')
plt.plot(x5, it_dim5_seq, linewidth=1.5, color='gray')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
