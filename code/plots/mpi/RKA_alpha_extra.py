...
# python3 plots/mpi/RKA_alpha.py
...
filename_fig = "RKA_alpha_time_20"
...
filename_fig = "RKA_alpha_speedup_2"
...
filename_fig = "RKA_alpha_speedup_4"
...
filename_fig = "RKA_alpha_speedup_8"
...
filename_fig = "RKA_alpha_speedup_20"
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x_1000, speedup_2_1000, color='orange')
plt.plot(x_1000, speedup_2_1000, linewidth=1.5, color='orange', label=r'Processses = 2')
plt.scatter(x_1000, speedup_4_1000, color='red')
plt.plot(x_1000, speedup_4_1000, linewidth=1.5, color='red', label=r'Processses = 4')
plt.scatter(x_1000, speedup_8_1000, color='blue')
plt.plot(x_1000, speedup_8_1000, linewidth=1.5, color='blue', label=r'Processses = 8')
plt.scatter(x_1000, speedup_20_1000, color='purple')
plt.plot(x_1000, speedup_20_1000, linewidth=1.5, color='purple', label=r'Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
filename_fig = "RKA_alpha_speedup_1000"
...
plt.plot(x_4000, speedup_2_4000, linewidth=1.5, color='orange', label=r'Processses = 2')
plt.scatter(x_4000, speedup_4_4000, color='red')
plt.plot(x_4000, speedup_4_4000, linewidth=1.5, color='red', label=r'Processses = 4')
plt.scatter(x_4000, speedup_8_4000, color='blue')
plt.plot(x_4000, speedup_8_4000, linewidth=1.5, color='blue', label=r'Processses = 8')
plt.scatter(x_4000, speedup_20_4000, color='purple')
plt.plot(x_4000, speedup_20_4000, linewidth=1.5, color='purple', label=r'Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
filename_fig = "RKA_alpha_speedup_4000"
...
plt.plot(x_10000, speedup_2_10000, linewidth=1.5, color='orange', label=r'Processses = 2')
plt.scatter(x_10000, speedup_4_10000, color='red')
plt.plot(x_10000, speedup_4_10000, linewidth=1.5, color='red', label=r'Processses = 4')
plt.scatter(x_10000, speedup_8_10000, color='blue')
plt.plot(x_10000, speedup_8_10000, linewidth=1.5, color='blue', label=r'Processses = 8')
plt.scatter(x_10000, speedup_20_10000, color='purple')
plt.plot(x_10000, speedup_20_10000, linewidth=1.5, color='purple', label=r'Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
# plt.yscale('log')
...
filename_fig = "RKA_alpha_speedup_10000"
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x_1000, time_par_2_1000, color='orange')
plt.plot(x_1000, time_par_2_1000, linewidth=1.5, linestyle='--', color='orange', label=r'Parallel - Processses = 2')
plt.scatter(x_1000, time_par_4_1000, color='red')
plt.plot(x_1000, time_par_4_1000, linewidth=1.5, linestyle='--', color='red', label=r'Parallel - Processses = 4')
plt.scatter(x_1000, time_par_8_1000, color='blue')
plt.plot(x_1000, time_par_8_1000, linewidth=1.5, linestyle='--', color='blue', label=r'Parallel - Processses = 8')
plt.scatter(x_1000, time_seq_2_1000, color='orange')
plt.plot(x_1000, time_seq_2_1000, linewidth=1.5, color='orange', label=r'Sequential - Processses = 2')
plt.scatter(x_1000, time_seq_4_1000, color='red')
plt.plot(x_1000, time_seq_4_1000, linewidth=1.5, color='red', label=r'Sequential - Processses = 4')
plt.scatter(x_1000, time_seq_8_1000, color='blue')
plt.plot(x_1000, time_seq_8_1000, linewidth=1.5, color='blue', label=r'Sequential - Processses = 8')
plt.scatter(x_1000, time_par_20_1000, color='purple')
plt.plot(x_1000, time_par_20_1000, linewidth=1.5, linestyle='--', color='purple', label=r'Parallel - Processses = 20')
plt.scatter(x_1000, time_seq_20_1000, color='purple')
plt.plot(x_1000, time_seq_20_1000, linewidth=1.5, color='purple', label=r'Sequential - Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_alpha_time_1000"
...
plt.plot(x_4000, time_par_2_4000, linewidth=1.5, linestyle='--', color='orange', label=r'Parallel - Processses = 2')
plt.scatter(x_4000, time_par_4_4000, color='red')
plt.plot(x_4000, time_par_4_4000, linewidth=1.5, linestyle='--', color='red', label=r'Parallel - Processses = 4')
plt.scatter(x_4000, time_par_8_4000, color='blue')
plt.plot(x_4000, time_par_8_4000, linewidth=1.5, linestyle='--', color='blue', label=r'Parallel - Processses = 8')
plt.scatter(x_4000, time_seq_2_4000, color='orange')
plt.plot(x_4000, time_seq_2_4000, linewidth=1.5, color='orange', label=r'Sequential - Processses = 2')
plt.scatter(x_4000, time_seq_4_4000, color='red')
plt.plot(x_4000, time_seq_4_4000, linewidth=1.5, color='red', label=r'Sequential - Processses = 4')
plt.scatter(x_4000, time_seq_8_4000, color='blue')
plt.plot(x_4000, time_seq_8_4000, linewidth=1.5, color='blue', label=r'Sequential - Processses = 8')
plt.scatter(x_4000, time_par_20_4000, color='purple')
plt.plot(x_4000, time_par_20_4000, linewidth=1.5, linestyle='--', color='purple', label=r'Parallel - Processses = 20')
plt.scatter(x_4000, time_seq_20_4000, color='purple')
plt.plot(x_4000, time_seq_20_4000, linewidth=1.5, color='purple', label=r'Sequential - Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_alpha_time_4000"
...
plt.plot(x_10000, time_par_2_10000, linewidth=1.5, linestyle='--', color='orange', label=r'Parallel - Processses = 2')
plt.scatter(x_10000, time_par_4_10000, color='red')
plt.plot(x_10000, time_par_4_10000, linewidth=1.5, linestyle='--', color='red', label=r'Parallel - Processses = 4')
plt.scatter(x_10000, time_par_8_10000, color='blue')
plt.plot(x_10000, time_par_8_10000, linewidth=1.5, linestyle='--', color='blue', label=r'Parallel - Processses = 8')
plt.scatter(x_10000, time_seq_2_10000, color='orange')
plt.plot(x_10000, time_seq_2_10000, linewidth=1.5, color='orange', label=r'Sequential - Processses = 2')
plt.scatter(x_10000, time_seq_4_10000, color='red')
plt.plot(x_10000, time_seq_4_10000, linewidth=1.5, color='red', label=r'Sequential - Processses = 4')
plt.scatter(x_10000, time_seq_8_10000, color='blue')
plt.plot(x_10000, time_seq_8_10000, linewidth=1.5, color='blue', label=r'Sequential - Processses = 8')
plt.scatter(x_10000, time_par_20_10000, color='purple')
plt.plot(x_10000, time_par_20_10000, linewidth=1.5, linestyle='--', color='purple', label=r'Parallel - Processses = 20')
plt.scatter(x_10000, time_seq_20_10000, color='purple')
plt.plot(x_10000, time_seq_20_10000, linewidth=1.5, color='purple', label=r'Sequential - Processses = 20')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_alpha_time_10000"
