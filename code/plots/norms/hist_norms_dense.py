...
# python3 plots/norms/hist_norms_dense.py 80000 10000
...
filename_norms = "outputs/dense_row_norms_" + str(M) + "_" + str(N) + ".txt"
...
filename_fig = "plots/norms/Dense_row_norms_" + str(M) + "_" + str(N)
