...
# python3 plots/omp/RKA_error.py 4000 1000 30000 30000 54.614

# ./bin/RKA_seq_error.exe ls_dense 2000 100 1 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 2 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 4 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 8 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 20 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 50 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 100 2000 1
# ./bin/RKA_seq_error.exe ls_dense 2000 100 1000 2000 1

# python3 plots/omp/RKA_error.py 2000 100 2000 2000 42.9463

# ./bin/RKA_seq_error.exe ls_dense 20000 1000 1 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 2 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 4 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 8 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 20 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 50 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 100 20000 10
# ./bin/RKA_seq_error.exe ls_dense 20000 1000 1000 20000 10

# python3 plots/omp/RKA_error.py 20000 1000 20000 20000 137.332
...
filename_100 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/omp/RKA_error_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_100 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/omp/RKA_res_" + str(M) + "_" + str(N) + "_1000.txt"
...
plot_title = r"Error evolution for a " + str(M) + " by " + str(N) + " matrix using the RKA method"
...
filename_fig1 = "RKA_error_" + str(M) + "_" + str(N)
...
plot_title = r"Residual evolution for a " + str(M) + " by " + str(N) + " matrix using the RKA method"
