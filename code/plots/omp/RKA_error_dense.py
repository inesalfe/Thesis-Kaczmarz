...
# python3 plots/omp/RKA_error_dense.py 20000 1000 55000 55000
# python3 plots/omp/RKA_error_dense.py 20000 1000 2500 2500

# python3 plots/omp/RKA_error_dense.py 4000 1000 30000 30000
# python3 plots/omp/RKA_error_dense.py 4000 1000 100000 100000
...
filename_1 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_50.txt"
# filename_100 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_100.txt"
# filename_1000 = "errors/seq/RKA_error_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_1 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_50.txt"
# filename_100 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_100.txt"
# filename_1000 = "errors/seq/RKA_res_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_fig1 = "RKA_error_dense_" + str(M) + "_" + str(N)
...
filename_fig2 = "RKA_res_dense_" + str(M) + "_" + str(N)
