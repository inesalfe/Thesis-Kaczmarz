...
# python3 plots/omp/RKA_seq_N_alpha_RT.py
...
filename = "outputs/omp/RKA_alpha_RT.txt";
...
filename_fig = "RKA_seq_N_alpha_RT_rows_2"
...
filename_fig = "RKA_seq_N_alpha_RT_rows_4"
...
filename_fig = "RKA_seq_N_alpha_RT_rows_8"
...
filename_fig = "RKA_seq_N_alpha_RT_it_2"
...
filename_fig = "RKA_seq_N_alpha_RT_it_4"
...
filename_fig = "RKA_seq_N_alpha_RT_it_8"
...
filename_fig = "RKA_seq_N_alpha_RT_time_2"
...
filename_fig = "RKA_seq_N_alpha_RT_time_4"
...
filename_fig = "RKA_seq_N_alpha_RT_time_8"
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x_1000, it_seq_1000, color='orange')
plt.plot(x_1000, it_seq_1000, linewidth=1.5, color='orange', label=r'Sequential')
plt.scatter(x_1000, total_lines_par_2_1000, color='red')
plt.plot(x_1000, total_lines_par_2_1000, linewidth=1.5, color='red', label=r'RKA with 2 Threads')
plt.scatter(x_1000, total_lines_par_4_1000, color='blue')
plt.plot(x_1000, total_lines_par_4_1000, linewidth=1.5, color='blue', label=r'RKA with 4 Threads')
plt.scatter(x_1000, total_lines_par_8_1000, color='green')
plt.plot(x_1000, total_lines_par_8_1000, linewidth=1.5, color='green', label=r'RKA with 8 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_seq_N_alpha_RT_rows_1000"
...
plt.scatter(x_1000, it_seq_1000, color='orange')
plt.plot(x_1000, it_seq_1000, linewidth=1.5, color='orange', label=r'Sequential')
plt.scatter(x_1000, it_par_2_1000, color='red')
plt.plot(x_1000, it_par_2_1000, linewidth=1.5, color='red', label=r'RKA with 2 Threads')
plt.scatter(x_1000, it_par_4_1000, color='blue')
plt.plot(x_1000, it_par_4_1000, linewidth=1.5, color='blue', label=r'RKA with 4 Threads')
plt.scatter(x_1000, it_par_8_1000, color='green')
plt.plot(x_1000, it_par_8_1000, linewidth=1.5, color='green', label=r'RKA with 8 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_seq_N_alpha_RT_it_1000"
...
fig = plt.figure(figsize=(10, 7))
plt.scatter(x_1000, time_seq_1000, color='orange')
plt.plot(x_1000, time_seq_1000, linewidth=1.5, color='orange', label=r'Sequential')
plt.scatter(x_1000, time_par_2_1000, color='red')
plt.plot(x_1000, time_par_2_1000, linewidth=1.5, color='red', label=r'RKA with 2 Threads')
plt.scatter(x_1000, time_par_4_1000, color='blue')
plt.plot(x_1000, time_par_4_1000, linewidth=1.5, color='blue', label=r'RKA with 4 Threads')
plt.scatter(x_1000, time_par_8_1000, color='green')
plt.plot(x_1000, time_par_8_1000, linewidth=1.5, color='green', label=r'RKA with 8 Threads')
plt.grid()
plt.legend()
# plt.title(plot_title)
plt.yscale('log')
...
filename_fig = "RKA_seq_N_alpha_RT_time_1000"
