...
# python3 plots/omp/RKA_uni_error.py 4000 1000 30000 30000 54.614
...
filename_1 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_50.txt"
filename_100 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/seq/RKA_uni_ls_error_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_1 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_50.txt"
filename_100 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/seq/RKA_uni_ls_res_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_fig1 = "RKA_uni_error_" + str(M) + "_" + str(N)
...
filename_fig2 = "RKA_uni_res_" + str(M) + "_" + str(N)
