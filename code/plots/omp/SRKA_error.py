...
# python3 plots/omp/SRKA_error.py 4000 1000 30000 30000 54.614
...
filename_1 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_50.txt"
filename_100 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/omp/SRKA_error_" + str(M) + "_" + str(N) + "_1000.txt"
...
filename_1 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_1.txt"
filename_2 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_2.txt"
filename_4 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_4.txt"
filename_8 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_8.txt"
filename_20 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_20.txt"
filename_50 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_50.txt"
filename_100 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_100.txt"
filename_1000 = "errors/omp/SRKA_res_" + str(M) + "_" + str(N) + "_1000.txt"
...
plot_title = r"Error evolution for a " + str(M) + " by " + str(N) + " matrix using the SRKA method"
...
filename_fig1 = "SRKA_error_" + str(M) + "_" + str(N)
...
plot_title = r"Residual evolution for a " + str(M) + " by " + str(N) + " matrix using the SRKA method"
...
filename_fig2 = "SRKA_res_" + str(M) + "_" + str(N)
