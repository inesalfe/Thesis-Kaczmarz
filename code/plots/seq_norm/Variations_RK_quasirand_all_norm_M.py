...
# python3 plots/seq_norm/Variations_RK_quasirand_all_norm_M.py
...
filename = "outputs/seq_norm/RK_quasirand_norm.txt";
...
RK_quasirand_it_2000 = it[0:6]
RK_quasirand_time_2000 = time[0:6]
RK_quasirand_it_4000 = it[6:13]
RK_quasirand_time_4000 = time[6:13]
RK_quasirand_it_20000 = it[13:22]
RK_quasirand_time_20000 = time[13:22]
RK_quasirand_it_40000 = it[22:31]
RK_quasirand_time_40000 = time[22:31]
RK_quasirand_it_80000 = it[31:40]
RK_quasirand_time_80000 = time[31:40]
...
RK_quasirand_sobol_it_2000 = it[0:6]
RK_quasirand_sobol_time_2000 = time[0:6]
RK_quasirand_sobol_it_4000 = it[6:13]
RK_quasirand_sobol_time_4000 = time[6:13]
RK_quasirand_sobol_it_20000 = it[13:22]
RK_quasirand_sobol_time_20000 = time[13:22]
RK_quasirand_sobol_it_40000 = it[22:31]
RK_quasirand_sobol_time_40000 = time[22:31]
RK_quasirand_sobol_it_80000 = it[31:40]
RK_quasirand_sobol_time_80000 = time[31:40]
...
filename_fig = "Variations_RK_quasirand_all_norm_M_time_2000"
...
filename_fig = "Variations_RK_quasirand_all_norm_M_it_2000"
...
filename_fig = "Variations_RK_quasirand_all_norm_M_time_4000"
...
filename_fig = "Variations_RK_quasirand_all_norm_M_it_4000"
...
plt.scatter(x_20000, RK_quasirand_time_20000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_20000, RK_quasirand_time_20000, linewidth=1.5, color='orange')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_time_20000"
...
plt.scatter(x_20000, RK_quasirand_it_20000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_20000, RK_quasirand_it_20000, linewidth=1.5, color='orange')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_it_20000"
...
plt.scatter(x_40000, RK_quasirand_time_40000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_40000, RK_quasirand_time_40000, linewidth=1.5, color='orange')
plt.scatter(x_40000, RK_quasirand_sobol_time_40000, linewidth=1.5, color='blue', label=r'SRK - Sobol')
plt.plot(x_40000, RK_quasirand_sobol_time_40000, linewidth=1.5, color='blue')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_time_40000"
...
plt.scatter(x_40000, RK_quasirand_it_40000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_40000, RK_quasirand_it_40000, linewidth=1.5, color='orange')
plt.scatter(x_40000, RK_quasirand_sobol_it_40000, linewidth=1.5, color='blue', label=r'SRK - Sobol')
plt.plot(x_40000, RK_quasirand_sobol_it_40000, linewidth=1.5, color='blue')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_it_40000"
...
plt.scatter(x_80000, RK_quasirand_time_80000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_80000, RK_quasirand_time_80000, linewidth=1.5, color='orange')
plt.scatter(x_80000, RK_quasirand_sobol_time_80000, linewidth=1.5, color='blue', label=r'SRK - Sobol')
plt.plot(x_80000, RK_quasirand_sobol_time_80000, linewidth=1.5, color='blue')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_time_80000"
...
plt.scatter(x_80000, RK_quasirand_it_80000, linewidth=1.5, color='orange', label=r'SRK - Halton')
plt.plot(x_80000, RK_quasirand_it_80000, linewidth=1.5, color='orange')
plt.scatter(x_80000, RK_quasirand_sobol_it_80000, linewidth=1.5, color='blue', label=r'SRK - Sobol')
plt.plot(x_80000, RK_quasirand_sobol_it_80000, linewidth=1.5, color='blue')
...
filename_fig = "Variations_RK_quasirand_all_norm_M_it_80000"
