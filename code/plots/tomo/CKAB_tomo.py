...
# python3 plots/tomo/CKAB_tomo.py ct_gaussian 19558 16384 3 15000 300
# 51 4.43728
# 58 4.41607
# 57 4.39683
# 58 4.39522

# python3 plots/tomo/CKAB_tomo.py ct_poisson 19558 16384 3 15000 300
# 99 3.91203
# 114 3.92197
# 111 3.90389
# 110 3.90141
...
filename_fig = "CKAB_tomo_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
...
filename_fig = "CKAB_tomo_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
