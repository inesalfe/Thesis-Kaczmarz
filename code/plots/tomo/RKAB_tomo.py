...
# python3 plots/tomo/RKAB_tomo.py ct_gaussian 19558 16384 3 15000 300
# 148 3.80374
# 147 3.78691
# 141 3.77772
# 141 3.77008

# python3 plots/tomo/RKAB_tomo.py ct_poisson 19558 16384 3 15000 300
# 156 3.77565
# 161 3.77571
# 149 3.76525
# 149 3.76042
...
filename_fig = "RKAB_tomo_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
...
filename_fig = "RKAB_tomo_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
