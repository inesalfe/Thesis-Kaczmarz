...
# python3 plots/tomo/RKAB_tomo_reg.py ct_gaussian 19558 16384 3 15000 500
# 298 3.09114
# 316 3.05312
# 316 3.03157
# 293 3.01858

# python3 plots/tomo/RKAB_tomo_reg.py ct_poisson 19558 16384 3 15000 500
# 333 3.07732
# 267 3.04207
# 267 3.01376
# 296 3.00029
...
filename_1 = error_folder + "RKAB_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(block_size) + "_" + str(max_it) + ".txt"
...
filename_2 = error_folder + "RKAB_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(block_size) + "_" + str(max_it) + ".txt"
...
filename_4 = error_folder + "RKAB_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(block_size) + "_" + str(max_it) + ".txt"
...
filename_8 = error_folder + "RKAB_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(block_size) + "_" + str(max_it) + ".txt"
...
filename_1 = error_folder + "RKAB_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(block_size) + "_" + str(max_it) + ".txt"
with open(filename_1) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_1 = []
...
filename_2 = error_folder + "RKAB_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(block_size) + "_" + str(max_it) + ".txt"
with open(filename_2) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_2 = []
...
filename_4 = error_folder + "RKAB_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(block_size) + "_" + str(max_it) + ".txt"
with open(filename_4) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_4 = []
...
filename_8 = error_folder + "RKAB_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(block_size) + "_" + str(max_it) + ".txt"
with open(filename_8) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_8 = []
...
filename_fig = "RKAB_tomo_error_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
...
filename_fig = "RKAB_tomo_res_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
