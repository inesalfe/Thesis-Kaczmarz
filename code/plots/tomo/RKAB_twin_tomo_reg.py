...
# python3 plots/tomo/RKAB_twin_tomo_reg.py ct_gaussian 19558 16384 3 750 15 15 23 68
# 61 1.49536
# 138 1.56513
# 301 1.53595
# 599 1.57754

# python3 plots/tomo/RKAB_twin_tomo_reg.py ct_poisson 19558 16384 3 750 24 21 30 110
# 68 1.37561
# 155 1.4229
# 326 1.4287
# 645 1.43085
...
filename_fig = "RKAB_twin_tomo_reg_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKAB_twin_tomo_reg_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKAB_twin_tomo_reg_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
