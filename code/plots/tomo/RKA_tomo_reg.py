...
# python3 plots/tomo/RKA_tomo_reg.py ct_gaussian 19558 16384 3 30000000
# 4470000 3.09114
# 4740000 3.04958
# 4750000 3.02856
# 4400000 3.01788

# python3 plots/tomo/RKA_tomo_reg.py ct_poisson 19558 16384 3 30000000
# 5060000 3.07907
# 4680000 3.03948
# 4680000 3.01245
# 4450000 2.99872

# python3 plots/tomo/RKA_tomo_reg.py ct_gaussian 19558 16384 3 10000000
# 4470000 3.09114
# 4740000 3.04958
# 4750000 3.02856
# 4400000 3.01788

# python3 plots/tomo/RKA_tomo_reg.py ct_poisson 19558 16384 3 10000000
# 5060000 3.07907
# 4680000 3.03948
# 4680000 3.01245
# 4450000 2.99872
...
filename_1 = error_folder + "RKA_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(max_it) + ".txt"
...
filename_2 = error_folder + "RKA_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(max_it) + ".txt"
...
filename_4 = error_folder + "RKA_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(max_it) + ".txt"
...
filename_8 = error_folder + "RKA_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(max_it) + ".txt"
...
filename_1 = error_folder + "RKA_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(max_it) + ".txt"
with open(filename_1) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_1 = []
...
filename_2 = error_folder + "RKA_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(max_it) + ".txt"
with open(filename_2) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_2 = []
...
filename_4 = error_folder + "RKA_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(max_it) + ".txt"
with open(filename_4) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_4 = []
...
filename_8 = error_folder + "RKA_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(max_it) + ".txt"
with open(filename_8) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_8 = []
...
filename_fig = "RKA_tomo_error_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKA_tomo_res_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
