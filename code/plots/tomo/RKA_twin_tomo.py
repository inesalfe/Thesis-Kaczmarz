...
# python3 plots/tomo/RKA_twin_tomo.py ct_gaussian 19558 16384 3 750 13 12 23 57


# python3 plots/tomo/RKA_twin_tomo.py ct_poisson 19558 16384 3 750 26 13 118 582
...
filename_fig = "RKA_twin_tomo_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKA_twin_tomo_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKA_twin_tomo_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
