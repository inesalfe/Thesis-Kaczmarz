...
# python3 plots/tomo/RKA_twin_tomo_reg.py ct_gaussian 19558 16384 3 750 15 22 20 77
# 61 1.49536
# 136 1.47044
# 271 1.53168
# 664 1.45647

# python3 plots/tomo/RKA_twin_tomo_reg.py ct_poisson 19558 16384 3 750 24 33 66 507
# 68 1.37561
# 158 1.34309
# 348 1.34574
# 732 1.34752
...
filename_1 = error_folder + "RKA_twin_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(max_it) + ".txt"
...
filename_2 = error_folder + "RKA_twin_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(max_it) + ".txt"
...
filename_4 = error_folder + "RKA_twin_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(max_it) + ".txt"
...
filename_8 = error_folder + "RKA_twin_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(max_it) + ".txt"
...
filename_1 = error_folder + "RKA_twin_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(max_it) + ".txt"
with open(filename_1) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_error_diff_1 = []
...
filename_2 = error_folder + "RKA_twin_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(max_it) + ".txt"
with open(filename_2) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_error_diff_2 = []
...
filename_4 = error_folder + "RKA_twin_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(max_it) + ".txt"
with open(filename_4) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_error_diff_4 = []
...
filename_8 = error_folder + "RKA_twin_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(max_it) + ".txt"
with open(filename_8) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_error_diff_8 = []
...
filename_1 = error_folder + "RKA_twin_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_1_" + str(max_it) + ".txt"
with open(filename_1) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_1 = []
...
filename_2 = error_folder + "RKA_twin_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_2_" + str(max_it) + ".txt"
with open(filename_2) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_2 = []
...
filename_4 = error_folder + "RKA_twin_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_4_" + str(max_it) + ".txt"
with open(filename_4) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_4 = []
...
filename_8 = error_folder + "RKA_twin_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_8_" + str(max_it) + ".txt"
with open(filename_8) as f:
	lines = f.read().splitlines()
file_size = len(lines)
it_res_8 = []
...
filename_fig = "RKA_twin_tomo_reg_error_diff_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKA_twin_tomo_reg_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "RKA_twin_tomo_reg_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
