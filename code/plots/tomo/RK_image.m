...
filename = "../../outputs/tomo_poisson/RK_sol_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + "_" + int2str(it_poisson) + ".txt";
x_poisson = load(filename);

%% RK Gaussian

filename = "../../outputs/tomo_gauss/RK_sol_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + "_" + int2str(it_gauss) + ".txt";
...
filename_fig = "pdf_poisson/RK_poisson_x_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + "_" + int2str(it_poisson) + ".pdf";
...
% caxis manual
% caxis([min_val max_val])
filename_fig = "pdf_gauss/RK_gauss_x_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + "_" + int2str(it_gauss) + ".pdf";
