...
# python3 plots/tomo/SRKABWOR_tomo_reg.py ct_gaussian 19558 16384 3 15000 500
# 79 2.11544
# 85 1.96496
# 103 1.92552
# 106 1.97893

# python3 plots/tomo/SRKABWOR_tomo_reg.py ct_poisson 19558 16384 3 15000 500
# 153 1.49899
# 183 1.39845
# 179 1.38714
# 197 1.38842
...
filename_fig = "SRKABWOR_tomo_error_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
...
filename_fig = "SRKABWOR_tomo_res_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(block_size) + "_" + str(max_it)
