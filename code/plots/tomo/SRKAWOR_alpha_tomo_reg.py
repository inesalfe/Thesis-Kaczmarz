...
# python3 plots/tomo/SRKAWOR_alpha_tomo_reg.py ct_gaussian 19558 16384 3 30000000 1 1.5 2 4
# 1150000 2.10878
# 1150000 1.95169
# 1060000 1.8437
# 620000 2.09668

# python3 plots/tomo/SRKAWOR_alpha_tomo_reg.py ct_poisson 19558 16384 3 30000000 1 1.5 2 4
# 2370000 1.50009
# 1850000 1.49617
# 1660000 1.50505
# 920000 1.66972

# python3 plots/tomo/SRKAWOR_alpha_tomo_reg.py ct_gaussian 19558 16384 3 10000000 1 1.5 2 4
# 1150000 2.10878
# 1150000 1.95169
# 1060000 1.8437
# 620000 2.09668

# python3 plots/tomo/SRKAWOR_alpha_tomo_reg.py ct_poisson 19558 16384 3 10000000 1 1.5 2 4
# 2370000 1.50009
# 1850000 1.49617
# 1660000 1.50505
# 920000 1.66972
...
filename_fig = "SRKAWOR_alpha_tomo_reg_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "SRKAWOR_alpha_tomo_reg_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
