...
# python3 plots/tomo/SRKAWOR_tomo.py ct_gaussian 19558 16384 3 30000000
# 700000 4.67279
# 820000 4.11619
# 1290000 3.97455
# 1430000 3.9339

# python3 plots/tomo/SRKAWOR_tomo.py ct_poisson 19558 16384 3 30000000
# 1400000 3.87705
# 1890000 3.74092
# 2120000 3.71168
# 2290000 3.70279

# python3 plots/tomo/SRKAWOR_tomo.py ct_gaussian 19558 16384 3 10000000
# 700000 4.67279
# 820000 4.11619
# 1290000 3.97455
# 1430000 3.9339

# python3 plots/tomo/SRKAWOR_tomo.py ct_poisson 19558 16384 3 10000000
# 1400000 3.87705
# 1890000 3.74092
# 2120000 3.71168
# 2290000 3.70279
...
filename_fig = "SRKAWOR_tomo_error_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
...
filename_fig = "SRKAWOR_tomo_res_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
