...
# python3 plots/tomo/mutual_tomo_reg.py ct_gaussian 19558 16384 3 200
# 49 1.50942

# python3 plots/tomo/mutual_tomo_reg.py ct_poisson 19558 16384 3 200
# 51 1.38874
...
filename_fig = "mutual_tomo_reg_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
