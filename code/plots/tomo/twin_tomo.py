...
# python3 plots/tomo/twin_tomo.py ct_gaussian 19558 16384 3 200 13
# 54 4.13559

# python3 plots/tomo/twin_tomo.py ct_poisson 19558 16384 3 200 26
# 94 3.77043
...
filename_fig = "twin_tomo_" + str(M) + "_" + str(N) + "_" + str(seed) + "_" + str(max_it)
