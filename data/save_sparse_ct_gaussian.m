function save_sparse_ct_gaussian(N_pixels,theta,seed,eta)
    ...
    fileID = fopen('ct_gaussian/carac.txt','a+');
    ...
    fileID_error = fopen('ct_gaussian/error_details.txt','a+');
    ...
    filename_fig = "ct_gaussian/x_ls_reg_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".png";
    ...
    filename_idx_pixels = "ct_gaussian/idx_pixels_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    ...
    filename_logic_pixels = "ct_gaussian/logic_pixels_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    ...
    filename_x_ls_reg = "ct_gaussian/x_ls_reg_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
